...
class Draw():
    ...
    def draw_game_menu(self,mode,mode_map,window):
        ...
        table_surface.blit(mode_game_left_txt, (WIDTH * 0.35, 100))
        table_surface.blit(mode_game_changed, (WIDTH * 0.38, 100))
        table_surface.blit(mode_game_right_txt, (WIDTH * 0.44, 100))
